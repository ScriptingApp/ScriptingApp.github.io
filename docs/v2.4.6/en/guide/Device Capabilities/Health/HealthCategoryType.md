...
description: This interface provides a way to define and manage health category types, which represent qualitative health data such as sleep analysis, mood, or menstrual cycle.
tag: PRO
---
