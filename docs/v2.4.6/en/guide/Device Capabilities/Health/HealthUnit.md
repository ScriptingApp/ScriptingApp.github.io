---
title: HealthUnit
description: This interface provides a way to define and manage health units, which represent the measurement units for health data such as kilograms, meters, or beats per minute.
tag: PRO
---
