---
title: HealthCorrelation
description: Represents a health correlation, which is a relationship between two or more health data samples, such as blood pressure readings and heart rate.
tag: PRO
---
